...
function addtoocart(index){
let selectitems = products[index]; 
if(cartitems.includes(selectitems)){
let itemsindex = cartitems.indexOf(selectitems);    
cartitems[itemsindex].quantity += 1;  
}
else{
